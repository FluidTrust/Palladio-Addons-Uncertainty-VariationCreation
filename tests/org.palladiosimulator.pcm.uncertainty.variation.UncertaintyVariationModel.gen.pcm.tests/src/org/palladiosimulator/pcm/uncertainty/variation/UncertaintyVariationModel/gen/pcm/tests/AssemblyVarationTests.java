...
class AssemblyVarationTests {
    ...
    private static final String ASSEMBLY_UNCERTAINTY_MODEL_TEST_MODEL = "platform:/plugin/org.palladiosimulator.pcm.uncertainty.variation.UncertaintyVariationModel.gen.pcm.tests/tmp/assembly_test.uncertaintyvariationmodel";
    ...
    void testAssemblyUncertaintyVariationModel() {
        ...
        final URI uri = URI.createURI(
                ASSEMBLY_UNCERTAINTY_MODEL_TEST_MODEL);
