...
public class VaryingAllocationContextItemProvider extends VariationPointItemProvider {
	...
	public String getText(Object object) {
        String label = ((VaryingAllocationContext)object).getStateHandlerId();
        return label == null || label.length() == 0 ?
            getString("_UI_VaryingAllocationContext_type") :
            getString("_UI_VaryingAllocationContext_type") + " " + label;
    }
