		...
		IItemPropertySource
{
	...
	/**
	 * This adds a property descriptor for the Variationpoint feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariationDescription_variationpoint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariationDescription_variationpoint_feature", "_UI_VariationDescription_type"),
				 UncertaintyVariationModelPackage.Literals.VARIATION_DESCRIPTION__VARIATIONPOINT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(UncertaintyVariationModelPackage.Literals.VARIATION_DESCRIPTION__TARGET_VARIATIONS);
		}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(VariationDescription.class))
		{
		...
		newChildDescriptors.add
			(createChildParameter
				(UncertaintyVariationModelPackage.Literals.VARIATION_DESCRIPTION__TARGET_VARIATIONS,
				 UncertaintyVariationModelFactory.eINSTANCE.createPrimitiveValue()));

		newChildDescriptors.add
			(createChildParameter
				(UncertaintyVariationModelPackage.Literals.VARIATION_DESCRIPTION__TARGET_VARIATIONS,
				 UncertaintyVariationModelFactory.eINSTANCE.createValueCollection()));
	}
